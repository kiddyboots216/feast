...
def get_testnet_eth(to_address):
...
def deploy_contract_A(w3, contract_interface, account):
    tx_hash = w3.eth.contract(
        abi=contract_interface['abi'],
        bytecode=contract_interface['bin']).constructor(3, [0,1,2], 0, 0, 5, [0,1,2], 3).transact({"from": account})
